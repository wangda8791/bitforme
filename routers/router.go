...
func Init() {
	...
	{
		v1.GET("/generate_address", api_v1.Generate_Address)
		v1.GET("/get_transaction", api_v1.Get_Transaction)
		v1.POST("/withdraw", api_v1.Withdraw)
	}
	...
	router.Run("0.0.0.0:" + utils.GetEnv("PORT", ""))
}
